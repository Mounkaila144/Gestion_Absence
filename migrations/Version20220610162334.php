 ...
 */
final class Version20220610162334 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE etudiant (id INT AUTO_INCREMENT NOT NULL, filier_id INT NOT NULL, nom VARCHAR(50) NOT NULL, prenom VARCHAR(50) NOT NULL, numero INT NOT NULL, annee INT NOT NULL, presence TINYINT(1) NOT NULL, INDEX IDX_717E22E36CDDA31B (filier_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE filier (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(100) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE presence (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, filier_id INT NOT NULL, present LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', date DATETIME NOT NULL, annee INT NOT NULL, INDEX IDX_6977C7A5A76ED395 (user_id), INDEX IDX_6977C7A56CDDA31B (filier_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE presence ADD CONSTRAINT FK_6977C7A5A76ED395 FOREIGN KEY (user_id) REFERENCES users (id)');
        $this->addSql('ALTER TABLE presence ADD CONSTRAINT FK_6977C7A56CDDA31B FOREIGN KEY (filier_id) REFERENCES filier (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE presence DROP FOREIGN KEY FK_6977C7A56CDDA31B');
